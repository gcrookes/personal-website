...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.316a31a6.mjs').then(interopDefault),
  "pages/index.vue": () => import('./_nuxt/index-styles.955aca57.mjs').then(interopDefault),
